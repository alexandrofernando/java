...
public class P105 {
	...
	public static void main(String args[]) {
		int set[][] = new int[][] {
				...
				{ 1211, 1212, 1287, 605, 1208, 1189, 1060, 1216, 1243, 1200,
						908, 1210 },
				...
				{ 1038, 1188, 1255, 1184, 594, 890, 1173, 1151, 1186, 1203,
						1187, 1195 },
				...
				{ 593, 1151, 1187, 1184, 890, 1040, 1173, 1186, 1195, 1255,
						1188, 1203 },
				{ 68, 46, 64, 33, 60, 58, 65 },
				{ 65, 43, 88, 87, 86, 99, 93, 90 },
				{ 83, 78, 107, 48, 84, 87, 96, 85 },
				{ 1188, 1173, 1256, 1038, 1187, 1151, 890, 1186, 1184, 1203,
						594, 1195 },
				...
				{ 1038, 1184, 593, 890, 1188, 1173, 1187, 1186, 1195, 1150,
						1203, 1255 },
				{ 343, 364, 388, 402, 191, 383, 382, 385, 288, 374 },
				{ 1187, 1036, 1183, 591, 1184, 1175, 888, 1197, 1182, 1219,
						1115, 1167 },
				...
				{ 1151, 1255, 1195, 1173, 1184, 1186, 1188, 1187, 1203, 593,
						1038, 891 },
				...
				{ 1219, 1183, 1182, 1115, 1035, 1186, 591, 1197, 1167, 887,
						1184, 1175 },
				...
				{ 1187, 1151, 890, 593, 1194, 1188, 1184, 1173, 1038, 1186,
						1255, 1203 },
				...
				{ 1184, 1197, 591, 1182, 1186, 889, 1167, 1219, 1183, 1033,
						1115, 1175 },
				...
				{ 36, 41, 54, 40, 25, 44, 42 }, { 37, 48, 34, 59, 39, 41, 40 },
				{ 681, 603, 638, 611, 584, 303, 454, 607, 606, 605, 596 } };
		int sum = 0;
		for (int i = 0; i < set.length; i++) {
			Arrays.sort(set[i]);
			setSum = new HashSet[set[i].length + 1];
			for (int j = 0; j <= set[i].length; j++) {
				setSum[j] = new HashSet<Integer>();
			}
			setSum[0].add(0);
			if (isSpecialSumSet(set[i])) {
				for (int j = 0; j < set[i].length; j++) {
					sum += set[i][j];
				}
			}
	...
	static boolean isSpecialSumSet(int set[]) {
		for (int i = 0; i < set.length; i++) {
			if (i >= 2) {
				int sumNum = i / 2;
				int sumBottom = 0;
