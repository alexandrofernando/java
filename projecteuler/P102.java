public class P102 {
	public static void main(String args[]) {
		int triangles[][] = new int[][] { { -340, 495, -153, -910, 835, -947 },
				...
				{ 16, 324, 667, 708, 750, 3 }, { 485, -813, 19, 585, 71, 930 },
		...
		for (int i = 0; i < triangles.length; i++) {
			int cp1 = crossProduct(triangles[i][0], triangles[i][1],
					triangles[i][2], triangles[i][3], 0, 0);
			int cp2 = crossProduct(triangles[i][2], triangles[i][3],
					triangles[i][4], triangles[i][5], 0, 0);
			int cp3 = crossProduct(triangles[i][4], triangles[i][5],
					triangles[i][0], triangles[i][1], 0, 0);
			if ((long) cp1 * cp2 * cp3 != 0
					&& ((long) cp1 * cp2 < 0 || (long) cp1 * cp3 < 0)) {
				continue;
			}
			count++;
		}
